        ...
        <Box className="menu_wrapper">
          <Box className="outer-box with_border">
            ...
            <Box className="inner-box">
              ...
              <Link
                href="https://onlyoffice.com/form-creator.aspx"
                className="nav_2nd_menu_link"
              >
                Form creator
              </Link>
            ...
            <Box className="inner-box">
              <Link
                href="https://onlyoffice.com/docs-cloud.aspx"
                className="nav_2nd_menu_link"
              >
                Cloud Edition
              </Link>
              <Link
                href="https://onlyoffice.com/docs-enterprise.aspx"
                className="nav_2nd_menu_link"
              >
                Enterprise Edition
              </Link>
          ...
          <Box className="outer-box">
            ...
            <Box className="inner-box">
              ...
              <Link
                href="https://onlyoffice.com/projects.aspx"
                className="nav_2nd_menu_link"
              >
                Projects
              </Link>
              <Link
                href="https://onlyoffice.com/calendar.aspx"
                className="nav_2nd_menu_link"
              >
                Calendar
              </Link>
            ...
            <Box className="inner-box">
              <Link
                href="https://onlyoffice.com/cloud-office.aspx"
                className="nav_2nd_menu_link"
              >
                Cloud Edition
              </Link>
          ...
          <Box className="outer-box">
            ...
            <Box id="oforms_div" className="menu_pic_div">
              ...
              <p id="oforms_header" className="menu_pic_header">
                Free <span className="nowrap">ready-to-fill</span> out online
                document forms
              </p>
            </Box>
          </Box>
          ...
          <Box className="outer-box">
            ...
            <Box id="latest_news_div" className="menu_pic_div">
              ...
              <p id="latest_news_header" className="menu_pic_header">
                ONLYOFFICE Docs 7.0: online forms, password protection in
                sheets, collaboration improvements and much more
              </p>
            </Box>
          </Box>
        </Box>
